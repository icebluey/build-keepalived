...
cd "${_tmp_dir}"
wget -q -c -t 9 -T 9 \
"https://github.com/icebluey/k8s/releases/download/v2024-06-15/containerd-1.7.18-1_amd64.tar.xz"
wget -q -c -t 9 -T 9 \
"https://github.com/icebluey/k8s/releases/download/v2024-06-15/docker-only-26.1.4-1_amd64.tar.xz"
